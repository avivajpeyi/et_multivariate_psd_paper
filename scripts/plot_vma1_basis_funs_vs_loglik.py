...
#number of basis funs vs max log lokelihood for vma1 model with length 256, 512 and 1024.
fig, axes = plt.subplots(3, 1, figsize=(10, 18), sharex=True, sharey=False)
labels = ['n = 256', 'n = 512', 'n = 1024']
for i, ax in enumerate(axes):
    ax.plot(x, basis_vs_max_lnl[:, i+3])
...
plt.savefig(f'{paths.figures}/vma1_basis_funs_vs_loglik.pdf', dpi=300)