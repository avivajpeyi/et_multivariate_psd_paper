...
data = pd.read_csv(f'{paths.data}/ET_uncorr_lr_low_basis_vs_lnl_combined_results.csv')
data = data.values
number_basis = data[:,0]
max_lnl = data[:,1]
...
plt.savefig(f'{paths.figures}/ET_uncorr_basis_funs_vs_loglik.pdf', dpi=300)