...
file_path_x = f'{paths.data}/X_ETnoise_GP.hdf5'
with h5py.File(file_path_x, 'r') as f:
    X_ETnoise_GP = f['E1:STRAIN']

file_path_y = f'{paths.data}/Y_ETnoise_GP.hdf5'
with h5py.File(file_path_y, 'r') as f:
    Y_ETnoise_GP = f['E2:STRAIN']

file_path_z = f'{paths.data}/Z_ETnoise_GP.hdf5'
...
file_path = f'{paths.data}/ETnoise_correlated_GP_uniform_spec_matrices_XYZ.hdf5'
...
plt.savefig(f'{paths.figures}/ETnoise_corr_psd.pdf', dpi=300)
#---------------------------------------------------------------------------------------------------------
#estimated squared coherence (median, lower, upper)
file_path = f'{paths.data}/ETnoise_correlated_GP_uniform_squared_coh_XYZ.hdf5'
with h5py.File(file_path, 'r') as f:
...
plt.savefig(f'{paths.figures}/ETnoise_corr_coh.pdf', dpi=300)
