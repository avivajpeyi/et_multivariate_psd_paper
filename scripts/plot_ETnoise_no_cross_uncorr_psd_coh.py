...
plt.savefig(f'{paths.figures}/ETnoise_no_cross_uncorr_psd.pdf', dpi=300)
#---------------------------------------------------------------------------------------------------------
#estimated squared coherence (median, lower, upper)
file_path = f'{paths.figures}/ETnoise_no_cross_uncorrelated_GP_uniform_squared_coh_XYZ.hdf5'
with h5py.File(file_path, 'r') as f:
...
plt.grid(True)
plt.savefig(f'{paths.figures}/ETnoise_no_cross_uncorr_coh.pdf', dpi=300)
