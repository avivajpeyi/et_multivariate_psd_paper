...
\begin{figure}
\centering
  \includegraphics[width=10cm]{et_basis_fns.pdf}
...
\begin{figure*}[htbp]
\centering
\begin{subfigure}{0.5\columwidth}
  \centering
  \includegraphics[width=\columwidth]{caseA_psd.pdf}
  \caption{Case A PSD}
  \label{fig:caseA_psd}
\end{subfigure}
\hfill
\begin{subfigure}{0.5\columwidth}
  \centering
  \includegraphics[width=\columwidth]{caseBC_psd.pdf}
...
\begin{figure}[h]
  \includegraphics[width=\columnwidth]{lnl_vs_nchunks.pdf}
  \caption{.}
